      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex justify-center gap-4">
            <a href="/jobs" className="px-8 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow">
              🔍 Find Jobs
            </a>
            <a href="/post-job" className="px-8 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg shadow">
              💼 Post a Job
            </a>
            <a href="/signup" className="px-8 py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-lg shadow">
              🚀 Get Started
            </a>
          </div>
        </div>
